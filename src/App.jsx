...
import videos from './images/videos.mp4';
  ...
  //       <div className="header">
  //         <div className="logo">
  //                 <img src={th}   height="250px" alt="img"/>
  //         </div>
  //         <div className="input">
  //           <input ></input><span><FaSearch /></span>
  //           </div> 
  //           </div> 
  ...
  //              <div className="icon"><SiYoutubegaming/> </div>
  //         </div>
  //         <div className="Right">
  //           <div className="row1">
  //             <div className="img1">
  //               <img className="img1" src={css} height="250px" width="250px" alt="img"/>
  //               <h1>Sports</h1>
  //             </div>
  //             <div className="img1">
  //               <img className="img1" src={html} height="250px" width="250px" alt="img"/>
  //               <h1>Sports</h1>
  //             </div>
  //             <div className="img1">
  //               <img className="img1" src={graph} height="250px" width="250px" alt="img"/>
  //               <h1>Sports</h1>
  //             </div>
  //           </div>
  //           <div className="row2">
  //             <div className="img1">
  //               <img className="image1" src={img2} height="250px" width="250px" alt="img"/>
  //               <h1>Sports</h1>
  
  //             </div>
  //             <div className="img1">
  //               <img className="image1" src={image} height="250px" width="250px" alt="img"/>
  //               <h1>Sports</h1>
  //             </div>
  //             <div className="img1">
  //               <img className="image1" src={images} height="250px" width="250px" alt="img"/>
  //               <h1>Sports</h1>
  //             </div>
  //           </div>
  //           <div className="row3">
  //             <div className="img1">
  //               <img className="image1" src={img} height="250px" width="450px" alt="img"/>
  //               <h1>Sports</h1>
  //             </div>
  //             <div className="img1">
  //               <img className="image1" src={download} height="250px" width="450px" alt="img"/>
  //               <h1>Sports</h1>
  //             </div>
  //             <div className="img1">
  //               <img className="image1" src={run} height="250px" width="450px" alt="img"/>
  //               <h1>Sports</h1>
  //             </div>
  //           </div>
  //         </div>
